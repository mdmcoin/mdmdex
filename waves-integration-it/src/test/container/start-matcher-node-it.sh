...
java ${WAVES_OPTS} -DTN.wallet.password=blablabla -cp "/usr/share/TN/lib/plugins/*:/usr/share/TN/lib/*" com.wavesplatform.Application ${WAVES_NODE_CONFIGPATH} &>> ${DETAILED_LOG_PATH} &
