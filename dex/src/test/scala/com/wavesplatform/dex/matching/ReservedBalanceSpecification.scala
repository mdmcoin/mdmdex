...
class ReservedBalanceSpecification
  ...
  forAll(
    Table(
      ...
      (SELL, 123.TN, 3.usd, WAVES, amtMap(500.TN, 500.usd, 50.eth), amtMap(waves = 124.TN)), // fee in spent asset
      (SELL, 123.TN, 3.usd, USD, amtMap(500.TN, 500.usd, 50.eth), amtMap(waves = 123.TN)), // fee in received asset
      ...
      /**
        ...
        */
      (SELL, 123.TN, 3.usd, WAVES, amtMap(100.TN, 500.usd, 50.eth), amtMap(waves = 100.TN)), // fee in spent asset
      (SELL, 123.TN, 3.usd, USD, amtMap(100.TN, 500.usd, 50.eth), amtMap(waves = 100.TN)), // fee in received asset
  ...
  forAll(
    Table(
      ...
      (BUY, 123.TN, 3.usd, USD, amtMap(500.TN, 500.usd, 50.eth), 100.TN, 2.usd, amtMap(usd = 169.19.usd)), // fee in spent asset,    USD: 123 * 3 [r] + 1 [f] - 100 * 2 [ea] - 100/123 [ef]
      (BUY, 123.TN, 3.usd, WAVES, amtMap(500.TN, 500.usd, 50.eth), 100.TN, 2.usd, amtMap(usd = 169.usd)),                     // fee in received asset, USD: 123 * 3 [r] - 100 * 2 [ea]
      (BUY, 123.TN, 3.usd, ETH, amtMap(500.TN, 500.usd, 50.eth), 100.TN, 2.usd, amtMap(usd = 169.usd, eth = 0.18699187.eth)), // fee in third asset,    USD: 123 * 3 [r] - 100 * 2 [ea], ETH: 1 [f] - 100/123 [ef]
      ...
      (SELL, 123.TN, 2.usd, WAVES, amtMap(500.TN, 500.usd, 50.eth), 100.TN, 3.usd, amtMap(waves = 23.18699187.TN)), // fee in spent asset,    WAVES: 123 [r] + 1 [f] - 100 [ea] - 100/123 [ef]
      (SELL, 123.TN, 2.usd, USD, amtMap(500.TN, 500.usd, 50.eth), 100.TN, 3.usd, amtMap(waves = 23.TN)),                       // fee in received asset, WAVES: 123 [r] - 100 [ea]
      (SELL, 123.TN, 2.usd, ETH, amtMap(500.TN, 500.usd, 50.eth), 100.TN, 3.usd, amtMap(waves = 23.TN, eth = 0.18699187.eth)), // fee in third asset,    WAVES: 123 [r] - 100 [ea], ETH: 1 [f] - 100/123 [ef]
      ...
      (BUY, 123.TN, 3.usd, USD, amtMap(500.TN, 300.usd, 50.eth), 100.TN, 2.usd, amtMap(usd = 99.19.usd)), // fee in spent asset,    USD: 300 [afs] - 100 * 2 [ea] - 100/123 [ef]
      (BUY, 123.TN, 3.usd, WAVES, amtMap(500.TN, 300.usd, 50.eth), 100.TN, 2.usd, amtMap(usd = 100.usd)),                     // fee in received asset, USD: 300 [afs] - 100 * 2 [ea]
      (BUY, 123.TN, 3.usd, ETH, amtMap(500.TN, 300.usd, 50.eth), 100.TN, 2.usd, amtMap(usd = 100.usd, eth = 0.18699187.eth)), // fee in third asset,    USD: 300 [afs] - 100 * 2 [ea], ETH: 1 [f] - 100/123 [ef]
      ...
      (BUY, 100.TN, 3.usd, USD, amtMap(500.TN, 300.usd, 50.eth), 100.TN, 3.usd, amtMap(usd = 0.01.usd)), // fee in spent asset,    USD: 300 [afs] - 299.00 [ea*] - 0.99 [ef*]
      (BUY, 100.TN, 3.usd, USD, amtMap(500.TN, 290.usd, 50.eth), 100.TN, 3.usd, amtMap(usd = 0.01.usd)), // fee in spent asset,    USD: 290 [afs] - 289.03 [ea*] - 0.96 [ef*]
      (BUY, 100.TN, 3.usd, WAVES, amtMap(500.TN, 290.usd, 50.eth), 100.TN, 3.usd, amtMap(usd = 0.01.usd)),                     // fee in received asset, USD: 290 [afs] - 299.99 [ea*]
      (BUY, 100.TN, 3.usd, ETH, amtMap(500.TN, 290.usd, 50.eth), 100.TN, 3.usd, amtMap(usd = 0.01.usd, eth = 0.03336667.eth)), // fee in third asset,    USD: 290 [afs] - 289.99 [ea*], ETH = 1 [f] - 0.96663333 [ef*]
      /** market BUY order filled, available for spending = required by spendable asset */
      ...
      (SELL, 123.TN, 2.usd, WAVES, amtMap(110.TN, 500.usd, 50.eth), 100.TN, 3.usd, amtMap(waves = 9.18699187.TN)), // fee in spent asset,    WAVES: 110 [afs] - 100 [ea] - 100/123 [ef]
      (SELL, 123.TN, 2.usd, USD, amtMap(110.TN, 500.usd, 50.eth), 100.TN, 3.usd, amtMap(waves = 10.TN)),                       // fee in received asset, WAVES: 110 [afs] - 100 [ea]
      (SELL, 123.TN, 2.usd, ETH, amtMap(110.TN, 500.usd, 50.eth), 100.TN, 3.usd, amtMap(waves = 10.TN, eth = 0.18699187.eth)), // fee in third asset,    WAVES: 110 [afs] - 100 [ea], USD: 1 [f] - 100/123 [ef]
      ...
      (SELL, 123.TN, 2.usd, WAVES, amtMap(100.TN, 500.usd, 50.eth), 100.TN, 3.usd, amtMap(waves = 0.00000001.TN)), // fee in spent asset, WAVES: 100 [afs] - 99.19354838 [ea*] - 0.80645161 [ef*]
      (SELL, 123.TN, 2.usd, WAVES, amtMap(90.TN, 500.usd, 50.eth), 100.TN, 3.usd, amtMap(waves = 0.00000001.TN)), // fee in spent asset, WAVES:  90 [afs] - 89.27419354 [ea*] - 0.72580645 [ef*]
